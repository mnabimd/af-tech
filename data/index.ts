import { Code2, Database, Globe2, Layout, Smartphone, Terminal } from 'lucide-react';
...
export const services = [
   ...
   },
   {
      ...
      description: 'Scalable and secure backend solutions with modern architectures.',
   ...
   },
   {
      ...
      description: 'Streamline your development and deployment processes specific business needs.',
...
export const phases = [
      ...
      features: [
         {
            ...
            description: 'Detailed analysis of your business requirements and technical needs.'
         },
         {
   ...
   },
   {
      ...
      description: 'Developing a comprehensive project plan with clear deliverables and timelines.',
      features: [
         {
            title: 'Cost Analysis',
            description: 'Detailed breakdown of project costs and resource requirements.'
         },
         {
            title: 'Timeline Planning',
            description: 'Creating realistic timelines with key milestones and deliverables.'
         },
         {
            title: 'Resource Allocation',
            description: 'Strategic allocation of team members and technical resources.'
         }
      ]
   },
   {
      ...
      description: 'Creating detailed technical specifications and architectural designs.',
      features: [
         {
   ...
   },
   {
      ...
      description: 'Transforming designs into reality with cutting-edge development practices.',
      features: [
         {
...
export const gridItems = [
   {
      id: 1,
      title: 'We value strong client partnerships, emphasizing transparent and open communication.',
      description: '',
   ...
   {
      id: 4,
      title: 'A tech enthusiast driven by a deep passion for innovation and development.',
      description: '',
   ...
   {
      id: 5,
      title: 'And we show you how you can make it better',
      description: 'We offer a free, no-obligation audit of your current software',
...
export const contactDetails = [
   {
      icon: MapPin,
      title: 'Visit Us',
      details: ['123 Innovation Street', 'Kandahar, CA 94043', 'Kandahar Afghanistan']
   },
   {
      icon: Phone,
      title: 'Call Us',
