...
export function IndustriesSection() {
      ...
      return (
         ...
         >
            ...
            <div className="p-4 rounded-xl bg-white dark:bg-black-100 hover:bg-gray-100 dark:hover:bg-black/60 transition-colors">
               ...
               {<item.icon className="w-6 h-6 text-gray-800 dark:text-gray-200"></item.icon>}
            </div>
            {/* Text */}
   ...
   return (
      <section className="py-16 overflow-hidden mx-auto" style={{ maxWidth: '75%' }}>
         ...
         <div className="relative w-full max-w-7xl mx-auto px-4">
            ...
            <div>
               <InfiniteMovingCards renderItem={renderItem} items={[...industries]} />
            </div>
         </div>
      </section>
   );
